...
public class OptionalInfo {
	...
	public OptionalInfo(CustomsFldlst customs_Fldlst, String loadNbr, Integer keyCity, String agLabel,
			String dryIceLabel, String wineLabel, String wineLicNbr, String militaryLabel, String satDeliveryLabel,
			String internationalLabel, String greetingcardLabel, Long autoManifest) {
		super();
		Customs_Fldlst = customs_Fldlst;
		LoadNbr = loadNbr;
		KeyCity = keyCity;
		AgLabel = agLabel;
		DryIceLabel = dryIceLabel;
		WineLabel = wineLabel;
		WineLicNbr = wineLicNbr;
		MilitaryLabel = militaryLabel;
		SatDeliveryLabel = satDeliveryLabel;
		InternationalLabel = internationalLabel;
		GreetingcardLabel = greetingcardLabel;
	...
	public Integer getKeyCity() {
		return KeyCity;
	}

	public void setKeyCity(Integer keyCity) {
		KeyCity = keyCity;
	}
